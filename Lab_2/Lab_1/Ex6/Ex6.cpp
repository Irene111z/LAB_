...
int main()
{
	...
	int sec_in_100_years_ = sec_in_day * 365.2425 * 100;//вариант с переполнением
	int sec_in_1000_years_ = sec_in_day * 365.2425 * 1000;//вариант с переполнением

	double sec_in_100_years = sec_in_day * 365.2425 * 100;//нормальный результат
	double sec_in_1000_years = sec_in_day * 365.2425 * 1000;//нормальный результат
}
